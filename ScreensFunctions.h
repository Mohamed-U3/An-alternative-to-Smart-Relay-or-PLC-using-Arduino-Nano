...
void SubScreen3()
{
  ...
  if(PageNumber == 1)
  {
    if(isPagePrinted == PageNumber) //For the Dynamics in the page
    {
      ...
      lcd.setCursor(15, 2);
      if(D1_FlowSW_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
      

      lcd.setCursor(15, 3);
      if(D2_PhaseSq_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
    }
    else                           //for the statics in the page
    {
  ...
  else if(PageNumber == 2)
  {
    if(isPagePrinted == PageNumber) //For the Dynamics in the page
    {
      ...
      lcd.setCursor(15, 1);
      if(D3_HighPressure1_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
      
      lcd.setCursor(15, 2);
      if(D4_LowPressure1_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
      
      lcd.setCursor(15, 3);
      if(D5_OverLoadComperssor1_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
    }
    else                           //for the statics in the page
    {
  ...
  else if(PageNumber == 3)
  {
    if(isPagePrinted == PageNumber) //For the Dynamics in the page
    {
      ...
      lcd.setCursor(15, 1);
      if(D6_OverLoadCFM1_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
      
      lcd.setCursor(15, 2);
      if(D7_MotorProtector1_Alarm) lcd.print("Alarm");
      else lcd.print("     ");

      lcd.setCursor(15, 3);
      if(D8_OilPressure1_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
    }
    else                           //for the statics in the page
    {
  ...
  else if(PageNumber == 4)
  {
    if(isPagePrinted == PageNumber) //For the Dynamics in the page
    {
      ...
      lcd.setCursor(15, 1);
      if(D9_HighPressure2_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
      
      lcd.setCursor(15, 2);
      if(D10_LowPressure2_Alarm) lcd.print("Alarm");
      else lcd.print("     ");

      lcd.setCursor(15, 3);
      if(D11_OverLoadComperssor2_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
    }
    else                           //for the statics in the page
    {
  ...
  else if(PageNumber == 5)
  {
    if(isPagePrinted == PageNumber) //For the Dynamics in the page
    {
      ...
      lcd.setCursor(15, 1);
      if(D12_OverLoadCFM2_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
      
      lcd.setCursor(15, 2);
      if(D13_MotorProtector2_Alarm) lcd.print("Alarm");
      else lcd.print("     ");

      lcd.setCursor(15, 3);
      if(D14_OilPressure2_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
    }
    else                           //for the statics in the page
    {
  ...
  else if(PageNumber == 6)
  {
    if(isPagePrinted == PageNumber) //For the Dynamics in the page
    {
      ...
      lcd.setCursor(15, 1);
      if(temperature_difference_Alarm) lcd.print("Alarm");
      else lcd.print("     ");
      ...
      Serial.println(Temp_Alarm_reason1);  //For debugging
